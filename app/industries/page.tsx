      ...
      <div className="mt-16 grid gap-6 lg:grid-cols-2">
        {industries.map((industry, index) => (
          <FadeIn
            key={industry.title}
            delay={index * 0.08}
            className="rounded-[1.75rem] border border-white/8 bg-white/[0.03] p-7"
          >
            <p className="font-mono text-xs uppercase tracking-[0.28em] text-cyan-100/55">{industry.kicker}</p>
